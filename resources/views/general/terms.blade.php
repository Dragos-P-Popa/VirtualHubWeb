...
@section('content')
    <div class="terms">
        ...
        <div>
            <p>VirtualHub iOS, Android and Net ("us", "we", or "our") operates the https://vh-net.com/ website and the
                VirtualHub iOS, Android and Net mobile application (hereinafter referred to as the "Service").</p>
